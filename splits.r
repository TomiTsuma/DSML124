...
split <- function(path_to_spc, path_to_rds, path_to_splits){
  # for (chem in chemicals) {
    ...
    #     print(chemical)
    df <- fread(paste0(path_to_spc , chem , ".csv"), header=TRUE)
...
split("/home/tom/DSML124/outputFiles/PCC1/",
          "/home/tom/DSML124/outputFiles/rds/", "/home/tom/DSML124/outputFiles/splits")
